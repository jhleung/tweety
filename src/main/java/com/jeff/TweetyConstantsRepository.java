...
public class TweetyConstantsRepository {
    ...
    public static final String NULL_TWEET_ID_ERROR_MSG = "tweet id parameter missing";
    ...
    public static final String STATUS_NOT_FOUND_ERROR_MSG = "Parent Tweet to reply to does not exist.";
